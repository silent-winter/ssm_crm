...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#updateRemarkBtn").click(function () {
			$.ajax({
				...
				success: function (data) {
					...
					if(data.success){
						//修改内容
						$("#edit-" + data.remark.id).html(data.remark.noteContent);
						$("#edit2-" + data.remark.id).html(data.remark.editTime + " 由" + data.remark.editBy);
			...
			$.ajax({
				...
				success: function (data) {
					...
					if(data.success){
						...
						html += '<font color="gray">客户</font> <font color="gray">-</font> <b>${customer.name}</b> <small id="edit2-'+ data.remark.id +'" style="color: gray;"> '+ data.remark.createTime +' 由'+ data.remark.createBy +'</small>';
        ...
        $("#saveBtn").click(function () {
			$.ajax({
				url: "workbench/customer/createContacts.do",
				data: {
	...
	function showRemarkList() {
		$.ajax({
			url: "workbench/customer/getRemarkList.do",
			data: {
				"customerId": "${customer.id}"
			},
			type: "get",
			...
			success: function (data) {
				...
				$.each(data, function (i, n) {
					...
					html += '<font color="gray">客户</font> <font color="gray">-</font> <b>${customer.name}</b> <small id="edit2-'+ n.id +'" style="color: gray;"> '+ (n.editFlag == 0 ? n.createTime : n.editTime) +' 由'+ (n.editFlag == 0 ? n.createBy : n.editBy) +'</small>';
					html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
	...
	function showContactsList() {
		$.ajax({
			url: "workbench/customer/getContactsList.do",
			data: {
				"customerId": "${customer.id}"
			},
			type: "get",
...
<body>
					...
					<form class="form-horizontal" role="form" id="addContactsForm">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<select class="form-control" id="create-appellation">
								  	<option></option>
									<c:forEach items="${appellation}" var="v">
										<option value="${v.value}">${v.text}</option>
									</c:forEach>
								</select>
							</div>
						...
						<div class="form-group" style="position: relative;">
							...
							<div class="col-sm-10" style="width: 300px;">
								...
								<input type="hidden" value="${customer.id}" id="create-customerId">
							</div>
						</div>
	...
	<div>
		<div style="position: relative; top: 20px; left: 40px;">
			...
			<div>
				<a href="workbench/customer/createTran.do?id=${customer.id}" style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>新建交易</a>
			</div>
		</div>
	</div>
	...
	<div>
		<div style="position: relative; top: 20px; left: 40px;">
			...
			<div>
				<a href="javascript:void(0);" onclick="createContacts()" style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>新建联系人</a>
			</div>
		</div>
	</div>
