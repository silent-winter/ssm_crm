...
<body>
	...
	<form action="workbench/transaction/saveTran.do" method="post" id="saveTranForm" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control bottomTime" id="create-expectedClosingDate" name="expectedDate">
			</div>
		</div>
